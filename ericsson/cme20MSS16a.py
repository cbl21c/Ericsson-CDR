...
componentHash['transit'] = [
    ...
    'originatedCode',    # --F-- originatedCode [24]
    'iNMarkingOfMS',
    'callPosition',
    'eosInfo',
    'internalCauseAndLoc',
    ...
    'mobileStationRoamingNumberInfo'            # market correction Tag 111
]

# pad out to 122 elements, and fill in index 121
componentHash['transit'] = componentHash['transit'] + [None] * (122 - len(componentHash['transit']))
componentHash['transit'][121] = 'reroutingIndicator'
...
componentHash['mSOriginating'] = [
    ...
    'incompleteCallDataIndicator',
    'incompleteCompositeCDRIndicator',
    'originatedCode',    # --F-- originatedCode [66]
    'switchIdentity',
    'networkCallReference',
    ...
    'chargeInformation',
    'disconnectionDate',
    'reroutingIndicator',    # --F-- reroutingIndicator [121]
    'invocationOfCallHold',    # --F-- invocationOfCallHold [122]
    'retrievalOfHeldCall',    # --F-- retrievalOfHeldCall [123]
    'disconnectionTime',
    'originatingCarrier',
    'originatingChargeArea',
    'tDSCounter',
...
# pad out to 122 elements, and fill in indices 102, 121
...
componentHash['callForwarding'] = [
    ...
    'incompleteCallDataIndicator',
    'incompleteCompositeCDRIndicator',
    'originatedCode',    # --F-- originatedCode [55]
    'switchIdentity',
    'networkCallReference',
    'disconnectionDueToSystemRecovery',
    'forloppDuringOutputIndicator',
...
componentHash['mSOriginatingSMSinMSC'] = [
    ...
    'callingSubscriberIMEISV',
    None,    # no component with tag value 18
    'iCIOrdered',
    'outputForSubscriber',
    'miscellaneousInformation',
    'regionalServiceUsed',
...
componentHash['mSTerminatingSMSinMSC'] = [
    ...
    'teleServiceCode',
    'serviceCentreAddress',
    None,    # no component with tag value 16
    None,    # no component with tag value 17
    'iCIOrdered',
    'outputForSubscriber',
    'miscellaneousInformation',
    'regionalServiceUsed',
...
componentHash['sSProcedure'] = [
    ...
    'firstCallingLocationInformation',
    'callingSubscriberIMEISV',
    None,    # no component with tag value 14
    'iCIOrdered',
    'outputForSubscriber',
    'sSCode',
    'sSRequest',
...
componentHash['sSInvocationEventModule'] = [
    ...
    'eventCRIToMS',
    'incompleteCallDataIndicator',
    None,    # no component with tag value 8
    'networkCallReference',
...
componentHash['chargeRateChangeEventModule'] = [
    ...
    'tariffClass',
    None,    # no component with tag value 5
    None,    # no component with tag value 6
    'aIURRequested',
    'numberOfChannelsRequested',
    'channelCodingUsed',
]
